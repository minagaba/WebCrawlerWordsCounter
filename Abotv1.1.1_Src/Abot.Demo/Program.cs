...
namespace Abot.Demo
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //Uri uriToCrawl = new Uri("http://www.ynet.co.il");
            Uri uriToCrawl = new Uri("http://startupgrind.com/");
        ...
        static void crawler_ProcessPageCrawlCompleted(object sender, PageCrawlCompletedArgs e)
        {
            ...
            {
                bfile = true;
                System.IO.File.WriteAllLines(@"C:\Temp\test1.txt", words);
            }
        }
